...
<!-- Mobile Navigation bar -->
	...
	<div class="mob-navigation-bar">
		<div class="primary-options row pt-20 mx-0 pb-2 bg-white"><!-- Primary Nav -->
			<div class="col-xs-4 row mx-0 px-0">
				<div class="col-xs-6 icon px-0">
					<img class="nav-toggle-btn" src="IMG/icons/hamburger.svg">
					<img class="nav-toggle-btn hide" src="IMG/icons/cross.svg">
				</div>
				<div class="col-xs-6 icon px-0">
