 ...
 *     - id:  Product ID, used to create the link to the Shirt Details page
...
<li>
    <a href="<?php echo BASE_URL; ?>product.php/?id=<?php echo $product["product_id"]; ?>">
        <img class="img-fluid" src="<?php echo BASE_URL . $product["image"]; ?>" alt="<?php echo $product["product_description"]; ?>">
